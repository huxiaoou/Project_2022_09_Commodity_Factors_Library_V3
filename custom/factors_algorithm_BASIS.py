...
def factors_algorithm_BASIS(
    ...
    test_return_lib = CManagerLibWriterByDate(t_db_name=factor_lib_structure.m_lib_name, t_db_save_dir=factors_exposure_dir)
    test_return_lib.add_table(t_table=factor_lib_structure.m_tab)
    test_return_lib.save_factor_by_date(
