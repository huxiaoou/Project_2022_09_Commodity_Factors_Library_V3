...
print("... {} begin to plot cum ic for {}.{}".format(dt.datetime.now(), factor_lbl, uid))
...
if len(ic_cumsum_data) > 0:
    ...
    plot_lines(
        ...
        t_fig_name="ic_cumsum.{}.{}".format(factor_lbl, uid),
        t_save_dir=os.path.join(test_ic_dir, factor_lbl),
        t_colormap="jet"
    )

statistics_df = pd.DataFrame(statistics_data)
statistics_file = "statistics.{}.{}.csv".format(factor_lbl, uid)
